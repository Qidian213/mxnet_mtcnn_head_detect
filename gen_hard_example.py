...
def save_hard_example(net):
    ...
    image_dir = "/home/zzg/Opensource/mtcnn-master/data/wider/images"
    neg_save_dir = "./data/mtcnn2/48/negative"
    pos_save_dir = "./data/mtcnn2/48/positive"
    part_save_dir = "./data/mtcnn2/48/part"

    # load ground truth from annotation file
    # format of each line: image/path [x1,y1,x2,y2] for each gt_box in this image
    anno_file = './data/wider/imglists/train.txt'
    ...
    for im_idx, dets, gts in zip(im_idx_list, det_boxes, gt_boxes_list):
        ...
        if dets.shape[0]==0:
            continue
        img = cv2.imread(os.path.join(image_dir, im_idx+'.jpeg'))
...
def parse_args():
    ...
    parser.add_argument('--dataset_path', dest='dataset_path', help='dataset folder',
                        default='/home/zzg/Opensource/mtcnn-master/data/wider', type=str)
